 ...
 */
void inicializar_laberinto(juego_t* juego);//TERMINADA
 ...
 * hay pasillo.
 */
bool es_movimiento_valido(juego_t* juego, char tecla);//TERMINADA

/*
 * Moverá el jugador hacia la dirección especificada.
 * Dicho movimiento es válido.
 */
void mover_jugador(jugador_t* jugador, char direccion);//TERMINADA

/*
 * Moverá el rival a la próxima posición.
 */
void mover_rival(juego_t* juego);//TERMINADA
 ...
 */
int estado_juego(juego_t juego);//TERMINADA
 ...
 */
coordenada_t posicion_aleatoria();//TERMINADA

/*
 * Actualizará la matriz mostrada al usuario, con los elementos presentes 
 * en el juego.
 */
void actualizar_laberinto(juego_t juego, char laberinto[TAMANIO][TAMANIO]);//TERMINADA

/*
 * Mostrará el laberinto por pantalla.
 */
void mostrar_laberinto(char laberinto[TAMANIO][TAMANIO]);//TERMINADA
